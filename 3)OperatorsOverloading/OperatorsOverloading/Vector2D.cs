...
namespace OperatorsOverloading
{
    internal class Vector2D
    {
        ...
        public static Vector2D operator *(Vector2D v, double scalar) => new Vector2D(Math.Round(v.X * scalar, 2), Math.Round(v.Y * scalar, 2)); // умножение на число - сделала с округлением до 2 чисел после запятой
